...
/**
 * This is the item provider adapter for a {@link offers.Offer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OfferItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Offer_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Offer_name_feature", "_UI_Offer_type"),
				 OffersPackage.Literals.OFFER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OffersPackage.Literals.OFFER__CONDITIONS);
		}
	...
	public String getText(Object object) {
		String label = ((Offer)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OffersPackage.Literals.OFFER__CONDITIONS,
