...
/**
 * This is the item provider adapter for a {@link uk.ac.york.cs.eng2.offers.SubCategory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubCategoryItemProvider extends CategoryItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SubCategory_category_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SubCategory_category_feature", "_UI_SubCategory_type"),
				 OffersPackage.Literals.SUB_CATEGORY__CATEGORY,
				 true,
				 false,
				 true,
				 null,
