...
public class TriggerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trigger_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trigger_source_feature", "_UI_Trigger_type"),
				 OffersPackage.Literals.TRIGGER__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Trigger_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Trigger_target_feature", "_UI_Trigger_type"),
				 OffersPackage.Literals.TRIGGER__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OffersPackage.Literals.TRIGGER__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		TriggerType labelValue = ((Trigger)object).getType();
