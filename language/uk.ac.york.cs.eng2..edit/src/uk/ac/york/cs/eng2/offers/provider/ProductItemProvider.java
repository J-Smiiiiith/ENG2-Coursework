	...
	protected void addSubCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_subCategory_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_subCategory_feature", "_UI_Product_type"),
	...
	protected void addCategoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_category_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_category_feature", "_UI_Product_type"),
