...
public class TriggerImpl extends MinimalEObjectImpl.Container implements Trigger {
	 ...
	 */
	@Override
	public OfferRule getTarget() {
		if (target != null && target.eIsProxy()) {
			InternalEObject oldTarget = (InternalEObject)target;
			target = (OfferRule)eResolveProxy(oldTarget);
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OffersPackage.TRIGGER__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	 ...
	 * @generated
	 */
	public OfferRule basicGetTarget() {
		return target;
	}
	 ...
	 */
	@Override
	public void setTarget(OfferRule newTarget) {
		OfferRule oldTarget = target;
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OffersPackage.TRIGGER__TARGET, oldTarget, target));
	}
