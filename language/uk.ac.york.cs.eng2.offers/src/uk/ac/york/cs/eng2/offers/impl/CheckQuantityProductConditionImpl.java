 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.cs.eng2.offers.impl.CheckQuantityProductConditionImpl#getProducts <em>Products</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CheckQuantityProductConditionImpl extends CheckQuantityConditionImpl implements CheckQuantityProductCondition {
	...
	public EList<Product> getProducts() {
		if (products == null) {
			products = new EObjectResolvingEList<Product>(Product.class, this, OffersPackage.CHECK_QUANTITY_PRODUCT_CONDITION__PRODUCTS);
		}
		return products;
	}
