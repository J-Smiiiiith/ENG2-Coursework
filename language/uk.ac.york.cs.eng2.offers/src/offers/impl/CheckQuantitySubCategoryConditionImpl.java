 ...
 * </p>
 * <ul>
 *   <li>{@link offers.impl.CheckQuantitySubCategoryConditionImpl#getSubCategories <em>Sub Categories</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CheckQuantitySubCategoryConditionImpl extends CheckQuantityConditionImpl implements CheckQuantitySubCategoryCondition {
	...
	public EList<SubCategory> getSubCategories() {
		if (subCategories == null) {
			subCategories = new EObjectContainmentEList<SubCategory>(SubCategory.class, this, OffersPackage.CHECK_QUANTITY_SUB_CATEGORY_CONDITION__SUB_CATEGORIES);
		}
